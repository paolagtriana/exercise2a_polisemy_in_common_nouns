...
propositional_predicates = ['verdadero', 'falso', 'plausible', 'implausible', 'cierto',
                            ...
                            'probado', 'genuino', 'apropiado', 'legítimo', 'exacto',
                            'evidente', 'fáctico', 'infinito', 'interminable', 'perpetuo',
                            'imperecedero']
#We create an empty list that will be filled with the nouns that fulfill the conditions
nouns_info_cont = []
#Then we specify our conditions in the following loop
for token in doc:
...
print('Nouns that can denote informational content:', nouns_info_cont)
print('\n')
...
#We print our results
print('Nouns that can denote eventuality:', nouns_ev)
print('\n')
...
#Then we use the set() function to remove duplicates
